...
set CLASSPATH=%DITA_DIR%lib\Saxon-HE-12.7.jar;%CLASSPATH%
...
set CLASSPATH=%DITA_DIR%lib\logback-classic-1.5.18.jar;%CLASSPATH%
set CLASSPATH=%DITA_DIR%lib\logback-core-1.5.18.jar;%CLASSPATH%
